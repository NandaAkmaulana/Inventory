...
<div class="row" style="margin-top: -30px;">
	<div class="col-12">
		<div class="card">
			<div class="container">
				<div class="card-body">
					<button class="btn btn-outline-primary pull-right" data-toggle="modal" data-target="#tambah">Tambah customer</button>
							...
							<tbody id="isi">
								...
								while ($data = mysqli_fetch_array($customer)) {
									...
									<tr>
										...
										<td>
											<button class="btn btn-outline-success btn-block" data-toggle="modal" data-target="#update<?php echo $data['id_customer'] ?>"><i data-toggle="tooltip" title="Update customer" class="fa fa-edit"></i></button>
											<a href="?p=dc&act=del&id=<?php echo $data['id_customer'] ?>" onclick="return confirm('Hapus data customer?')" class="btn btn-outline-danger btn-block" data-toggle="tooltip" title="Hapus customer"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
									<?php
								}
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" autocomplete="off" value="<?php echo $data['jenis'] ?>" placeholder="Masukan Penanggung Jenis order" name="jenis" required="">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								<label>Jenis Order</label>
								<input type="text" class="form-control" autocomplete="off"  placeholder="Masukan Penanggung Jenis order" name="jenis" required="">
							</div>
						</div>
					</div>
				</div>
