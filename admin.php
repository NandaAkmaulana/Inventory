...
<head>
  ...
  <title>Inventory System | Admin Page</title>
  <link rel="apple-touch-icon" sizes="60x60" href="assets/logonya.png">
  <link rel="apple-touch-icon" sizes="76x76" href="assets/logonya.png">
  <link rel="apple-touch-icon" sizes="120x120" href="assets/logonya.png">
  <link rel="apple-touch-icon" sizes="152x152" href="assets/logonya.png">
  <link rel="shortcut icon" type="image/x-icon" href="assets/logonya.ico">
  <link rel="shortcut icon" type="image/png" href="assets/logonya.png">
...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout  vertical-menu 2-columns  fixed-navbar">
    ...
    <div class="navbar-wrapper">
      <div class="navbar-header">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item"><a href="admin.php" class="navbar-brand nav-link"><img alt="branding logo" src="assets/logobaru.png" data-expand="assets/logobaru.png" data-collapse="assets/kecil.png" class="brand-logo"></a></li>
  ...
  <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
    ...
    <div class="main-menu-header" style="">
      <center>
        <img  src="assets/2.jpg"  style="width: 160px; height:90px;">
    ...
    <div class="main-menu-content">
      <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
        ...
        <li class=" nav-item"><a href="?p=dc"><i class="icon-users"></i><span data-i18n="nav.dash.main" class="menu-title">Data Customer</span></a>
        </li>
